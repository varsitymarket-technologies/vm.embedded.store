...
<head>
    ...
    <style>
        :root {
            ...
            --color-text: #f5f5f5;
            --color-primary: #34d399; /* A modern, vibrant green */
...
<body>
    ...
    <header class="main-header">
        <div class="logo" data-view="shop-view"><?php e(__SITE_LOGO__); ?></div>
        <nav class="main-nav">
        ...
        <section id="checkout-view" class="view">
            <div class="container">
                ...
                <div class="checkout-summary">
                    ...
                    <div id="cart-total">
                        <span>Total</span>
                        <span id="total-price"><?php e(__CURRENCY__); ?> 0.00</span>
                    </div>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const fetchProducts = async () => {
            try {
                const response = await fetch('<?php e(__API_LINK__); ?>?state=products');
            ...
            productsToRender.forEach(product => {
                ...
                card.innerHTML = `
                    ...
                    <div class="product-card-info">
                        <h3>${product.name}</h3>
                        <p><?php e(__CURRENCY__); ?>${product.price.toFixed(2)}</p>
                    </div>
                `;
            ...
            productDetailView.innerHTML = `
                <div class="container">
                    ...
                    <div class="product-details">
                        <h1>${product.name}</h1>
                        <p class="price"><?php e(__CURRENCY__); ?>${product.price.toFixed(2)}</p>
            ...
            cart.forEach(item => {
                ...
                cartItemEl.innerHTML = `
                    ...
                    <div class="cart-item-info">
                        <h4>${product.name}</h4>
                        <p><?php e(__CURRENCY__); ?>${product.price.toFixed(2)} x ${item.quantity}</p>
                    </div>
                    <span><?php e(__CURRENCY__); ?>${(product.price * item.quantity).toFixed(2)}</span>
                `;
