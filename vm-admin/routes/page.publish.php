                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 pb-2 border-b border-shopifyBorder">
                    <div>
                        <div class="text-xs text-shopifySecondary flex items-center gap-1 mb-1">
                            <span>Online Store</span> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-lucide="chevron-right" aria-hidden="true" class="lucide lucide-chevron-right w-3 h-3">
                    ...
                    <div class="flex gap-2">
                        <button onclick="window.location.href='<?php echo $admin_base; ?>deploy'" class="bg-[#2c2d30] hover:bg-[#36373a] border border-shopifyBorder text-white px-3 py-1.5 rounded-lg font-medium text-sm transition flex items-center gap-1.5">
                        ...
                        <button onclick="publishTheme()" class="bg-shopifyGreen hover:bg-shopifyGreenHover text-white px-4 py-1.5 rounded-lg font-medium text-sm transition flex items-center gap-1.5 shadow-sm">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-lucide="upload-cloud" aria-hidden="true" class="lucide lucide-upload-cloud w-4 h-4">
