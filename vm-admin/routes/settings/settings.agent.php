            ...
            <div class="max-w-7xl mx-auto">
                <div class="flex items-center justify-between mb-8">
                    ...
                    <div class="flex items-center gap-3">
                        <span
                            class="px-3 py-1 rounded-full text-xs font-medium <?= $agent_enabled ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-600' ?>">
                            <?= $agent_enabled ? 'Enabled' : 'Disabled' ?>
                        </span>

                        <button type="submit"
                            class="px-4 py-2 bg-[#252526]  text-white rounded-lg text-sm font-medium hover:opacity-90">
                            Save Changes
                        </button>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 xl:grid-cols-[2fr_1fr] gap-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div
                            class="bg-gray-800 border border-white/5 p-5 transition-all duration-200 hover:border-white/10 rounded-xl">
                            ...
                            <div class="p-5 space-y-5">
                                ...
                                <div class="grid md:grid-cols-3 gap-4">
                                    <div>
                                        ...
                                        <select name="agent[provider]"
                                            class="w-full border border-white/5 p-5 transition-all duration-200 hover:border-white/10 rounded-lg px-3 py-2">
                                            <option value="openai" <?= $agent_provider === 'openai' ? 'selected' : '' ?>>OpenAI
                                            </option>
                                            <option value="mcp" <?= $agent_provider === 'mcp' ? 'selected' : '' ?>>MCP</option>
                                            <option value="custom" <?= $agent_provider === 'custom' ? 'selected' : '' ?>>Custom
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="agent[model]"
                                    ...
                                    <div>
                                        ...
                                        <select name="agent[response_style]"
                                            class="w-full border border-white/5 p-5 transition-all duration-200 hover:border-white/10 rounded-lg px-3 py-2">
                        ...
                        <div
                            ...
                            <div class="p-5 grid md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="password" name="agent[openai_api_key]"
                                        class="w-full border border-white/5 p-5 transition-all duration-200 hover:border-white/10 rounded-lg px-3 py-2"
                                        placeholder="sk-...">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="agent[openai_org_id]"
                        ...
                        <div
                            ...
                            <div class="p-5">
                                <textarea rows="12" name="agent[system_prompt]"
                    ...
                    <div class="space-y-6">
                        ...
                        <div
                            class="bg-gray-800 border border-white/5 p-5 transition-all duration-200 hover:border-white/10 rounded-xl p-5">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <input type="number" step="0.1" name="agent[temperature]"
                        ...
                        <div
                            class="bg-gray-50 border border-white/5 p-5 transition-all duration-200 hover:border-white/10 rounded-xl p-5">
