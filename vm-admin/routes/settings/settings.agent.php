                ...
                <div class="p-5 space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="agent[model]" value="<?= htmlspecialchars($agent_model, ENT_QUOTES, 'UTF-8') ?>" class="w-full bg-zinc-800 border border-zinc-700 rounded-lg px-3 py-2 text-white text-sm font-mono focus:outline-none focus:border-cyan-500 transition-colors" placeholder="gpt-5">
                        </div>
                        <div>
