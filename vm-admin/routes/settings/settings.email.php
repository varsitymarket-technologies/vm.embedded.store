            ...
            <div>
                <div class="flex items-center justify-between mb-2">
                    <div>
                        ...
                        <p class="text-zinc-500 text-xs mt-0.5">Supports <code class="text-violet-400">{{name}}</code>
                            and <code class="text-violet-400">{{message}}</code> tags</p>
                    </div>
...
<div id="previewContainer" class="hidden mt-6">
    <div class="bg-[#252526] border border-violet-500/30 rounded-xl overflow-hidden">
        <div class="px-5 py-3 border-b border-zinc-800 flex items-center justify-between">
            ...
            <button onclick="togglePreview()" class="text-zinc-500 hover:text-white transition-colors"><i
