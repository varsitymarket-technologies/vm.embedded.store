    ...
    <div class="bg-[#252526] border border-zinc-800 rounded-xl overflow-hidden">
        ...
        <div class="p-5 space-y-5">
            ...
            <div>
                ...
                <input type="text" name="branding[domain]" value="<?= htmlspecialchars($site_domain) ?>"
                ...
                <p class="text-zinc-500 text-xs mt-1.5">Changing this will move the store files to the new domain path
                    and update the store registry.</p>
            </div>
        </div>
