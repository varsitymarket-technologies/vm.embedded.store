    ...
    <main class="dash-main overflow-x-hidden bg-[#09090b] p-6 md:p-8">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
            <div>
                ...
                <p class="text-zinc-400 text-sm mt-1">Here's what's happening with <span
                        class="text-violet-400 font-medium"><?php echo htmlspecialchars($store_name); ?></span></p>
            </div>
            <a href="<?php echo $admin_base; ?>"
                class="bg-violet-600 hover:bg-violet-500 text-white px-5 py-2.5 rounded-lg text-sm font-medium transition-colors flex items-center gap-2 shadow-lg shadow-violet-500/20">
                Open Admin Panel
            </a>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            ...
            <div class="bg-zinc-900 border border-zinc-800 rounded-xl p-5 relative overflow-hidden">
                ...
                <a href="<?php echo $store_url; ?>" target="_blank"
                    class="text-violet-400 hover:text-violet-300 text-xs mt-2 inline-flex items-center gap-1 transition-colors">
            ...
            <div class="bg-zinc-900 border border-zinc-800 rounded-xl p-5">
                ...
                <div class="grid grid-cols-2 gap-2">
                    <a href="<?php echo $admin_base; ?>products"
                        class="flex items-center gap-2 px-3 py-2 rounded-lg bg-zinc-800 hover:bg-zinc-700 text-zinc-300 text-xs font-medium transition-colors">
        ...
        <div class="mb-8 relative overflow-hidden rounded-xl border border-zinc-800" id="carousel-wrapper">
            <div class="flex transition-transform duration-500 ease-in-out" id="carousel-track">
                <!-- Slide 1: Welcome -->
                <div class="w-full shrink-0 p-8 md:p-10 relative"
                    style="background: linear-gradient(135deg, #09090b 0%, #1a103d 50%, #0d0628 100%);">
                    <div class="flex flex-col md:flex-row items-start md:items-center gap-6">
                        ...
                        <div class="flex-1">
                            ...
                            <h3 class="text-xl font-bold text-white mt-1">Welcome to
                                <?php echo htmlspecialchars($store_name); ?>
                            </h3>
                            <p class="text-zinc-400 text-sm mt-2 max-w-lg">Add products, pick a theme, connect payments,
                                and publish. Your customers are waiting.</p>
                        </div>
                        <a href="<?php echo $admin_base; ?>products"
                            class="shrink-0 bg-violet-600 hover:bg-violet-500 text-white px-5 py-2.5 rounded-lg text-sm font-medium transition-colors">
                ...
                <!-- Slide 2: Analytics -->
                <div class="w-full shrink-0 p-8 md:p-10 relative"
                    style="background: linear-gradient(135deg, #09090b 0%, #0d2818 50%, #061a0e 100%);">
                    <div class="flex flex-col md:flex-row items-start md:items-center gap-6">
                        ...
                        <div class="flex-1">
                            <span class="text-emerald-400 text-xs font-bold uppercase tracking-widest">New
                                Feature</span>
                            <h3 class="text-xl font-bold text-white mt-1">Real-Time Analytics Dashboard</h3>
                            <p class="text-zinc-400 text-sm mt-2 max-w-lg">Track page views, visitors, referrers, and
                                device breakdowns — all without slowing your store.</p>
                        </div>
                        <a href="<?php echo $admin_base; ?>analytics"
                            class="shrink-0 bg-emerald-600 hover:bg-emerald-500 text-white px-5 py-2.5 rounded-lg text-sm font-medium transition-colors">
                ...
                <!-- Slide 3: API -->
                <div class="w-full shrink-0 p-8 md:p-10 relative"
                    style="background: linear-gradient(135deg, #09090b 0%, #0d1528 50%, #060d1a 100%);">
                    <div class="flex flex-col md:flex-row items-start md:items-center gap-6">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-zinc-400 text-sm mt-2 max-w-lg">Embed your products anywhere with our drop-in
                                SDK, or build custom integrations with the REST API.</p>
                        </div>
                        <a href="<?php echo $admin_base; ?>settings?tab=dev"
                            class="shrink-0 bg-sky-600 hover:bg-sky-500 text-white px-5 py-2.5 rounded-lg text-sm font-medium transition-colors">
                ...
                <!-- Slide 4: Growth -->
                <div class="w-full shrink-0 p-8 md:p-10 relative"
                    style="background: linear-gradient(135deg, #09090b 0%, #28210d 50%, #1a1506 100%);">
                    <div class="flex flex-col md:flex-row items-start md:items-center gap-6">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-zinc-400 text-sm mt-2 max-w-lg">Flash sales and limited-time discounts create
                                urgency. Pair with free delivery thresholds for maximum impact.</p>
                        </div>
                        <a href="<?php echo $admin_base; ?>discounts"
                            class="shrink-0 bg-amber-600 hover:bg-amber-500 text-white px-5 py-2.5 rounded-lg text-sm font-medium transition-colors">
            ...
            <button onclick="carouselPrev()"
                class="absolute left-3 top-1/2 -translate-y-1/2 bg-black/50 hover:bg-black/80 text-white w-9 h-9 rounded-full flex items-center justify-center transition-colors">
                <i class="bi bi-chevron-left"></i>
            </button>
            <button onclick="carouselNext()"
                class="absolute right-3 top-1/2 -translate-y-1/2 bg-black/50 hover:bg-black/80 text-white w-9 h-9 rounded-full flex items-center justify-center transition-colors">
        ...
        <div class="bg-zinc-900 border border-zinc-800 rounded-xl overflow-hidden">
            ...
            <iframe src="<?php echo $store_url; ?>" class="w-full border-none" style="height: 65vh;"
